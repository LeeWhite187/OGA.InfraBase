...
namespace OGA.DomainBase_Tests
{
     ...
     */
        [TestClass]
    public class PaginatedList_Int32_Tests
    {
        ...
        public void Test1()
        {
            ...
            using (var context = Get_TestContext(dbname))
            {
                ...
                var pl = OGA.DomainBase.QueryHelpers.PaginatedList<OGA.DomainBase_Tests.TestClass_Int32Id>.CreateAsync(query, 1, 10).Result;
        ...
        public void Test8()
        {
            ...
            using (var context = Get_TestContext(dbname))
            {
                ...
                // Declare an instance of our test class...
                var pl = OGA.DomainBase.QueryHelpers.PaginatedList<OGA.DomainBase_Tests.TestClass_Int32Id>.CreateAsync(query, 2, 10).Result;
        ...
        public void Test9()
        {
            ...
            using (var context = Get_TestContext(dbname))
            {
                ...
                // Declare an instance of our test class...
                var pl = OGA.DomainBase.QueryHelpers.PaginatedList<OGA.DomainBase_Tests.TestClass_Int32Id>.CreateAsync(query, 3, 10).Result;
        ...
        public void Test10()
        {
            ...
            using (var context = Get_TestContext(dbname))
            {
                ...
                try
                {
                    var pl = OGA.DomainBase.QueryHelpers.PaginatedList<OGA.DomainBase_Tests.TestClass_Int32Id>.CreateAsync(query, 0, 10).Result;
        ...
        public void Test11()
        {
            ...
            using (var context = Get_TestContext(dbname))
            {
                ...
                try
                {
                    var pl = OGA.DomainBase.QueryHelpers.PaginatedList<OGA.DomainBase_Tests.TestClass_Int32Id>.CreateAsync(query, 1, 0).Result;
